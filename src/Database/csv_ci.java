...
public class csv_ci {
    public static void ci_loader() throws FileNotFoundException {
        String csvFile = "C:\\Users\\sashr\\OneDrive\\Desktop\\nirma\\2nd year\\semester 3\\oops\\assinglemt\\innovative_Assingment\\src\\Database\\employee_ci_list.txt";
        String line;
        String csvSplitBy = ",";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            while ((line = br.readLine()) != null) {
                ...
                if (data.length == 6) {
                    ...
                    add_ci(name, age, sex, salary, counter, hourly_shift);
                } else {
